...
from app.devsearch_auth import utils
...
def reset_password_email_view(request):
    if request.method == "POST":
        ...
        if user is not None:
            ...
            return redirect("devsearch_auth:reset_password_sent")
    
    return render(request, "devsearch_auth/reset_password_email.html", {})


def reset_password_sent_view(request):
    return render(request, "devsearch_auth/reset_password_sent.html", {})
...
def reset_password_view(request, uidb64, token):
    ...
    if request.method == "POST":
        ...
        if new_password != confirm_password:
            ...
            return redirect("devsearch_auth:reset_password_confirm", uidb64, token)
        else:
...
def reset_password_complete_view(request):
    return render(request, "devsearch_auth/reset_password_complete.html", {})
...
def login_view(request):
    ...
    return render(request, "devsearch_auth/login-register.html", {"page": page})


def logout_view(request):
    logout(request)
    messages.info(request, "User was logged out")
    return redirect("devsearch_auth:login")
...
def register_view(request):
    ...
    return render(request, "devsearch_auth/login-register.html", {"page": page, "form": form})